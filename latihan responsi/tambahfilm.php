  ...
  <body>
    <div class="header">
        <div class="container">
            <div class="row align-items-center">
                <div class="col">
                    <h1 class="page-name">Tambah Film Baru</h1>
    ...
    <div class="container ms-4 mt-4">
        <form action="" method="post">
            ...
            <button type="submit" name="tambah" class="btn btn-success">Simpan</button> <a href="home.php"><button type="button" class="btn btn-secondary">Kembali</button></a>
